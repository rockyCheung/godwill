...
class Serializer(object):
    ...
    def dumps(self, request, response, body=None):
        ...
        data["vary"] = dict(
            ...
            for k, v in list(data["vary"].items())
        )
    ...
    def prepare_response(self, request, cached):
        ...
        # request
        for header, value in list(cached.get("vary", {}).items()):
    ...
    def _loads_v2(self, request, data):
        ...
        cached["response"]["headers"] = dict(
            ...
            for k, v in list(cached["response"]["headers"].items())
        )
        ...
        cached["vary"] = dict(
            ...
            for k, v in list(cached["vary"].items())
        )
